...
export const Header = ({ navToggle, setNavToggle }) => {
    return (
                ...
                <div className="header-left d-flex align-items-center gap-4">
                    ...
                    <div className="nxl-navigation-toggle">
                        {navToggle ? (
                            ...
                            <Link to="/" id="menu-mini-button" onClick={() => setNavToggle(prev => !prev)}>
                ...
                <div className="header-right ms-auto">
                    <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown nxl-h-item nxl-header-language d-none d-sm-flex">
                            ...
                            >
                                <img
                                    src="./assets/images/flags/4x3/us.svg"
                                    alt=""
